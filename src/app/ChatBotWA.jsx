...
export default function WhatsAppBot() {
  return (
    <div className="relative w-[min(92vw,380px)] h-[min(70vh,560px)]">
      <div className="flex h-full flex-col overflow-hidden rounded-3xl border border-emerald-200/60 bg-white/80 backdrop-blur-xl shadow-2xl dark:bg-black/60 dark:border-white/10">
        <div className="flex items-center justify-between px-4 py-3 border-b border-emerald-200/60 dark:border-white/10">
          <div className="flex items-center gap-3">
            <div className="h-9 w-9 rounded-xl bg-gradient-to-br from-green-500 to-emerald-600 text-white grid place-items-center shadow">
              <span className="text-xs font-bold">WA</span>
            </div>
            <div>
              <p className="text-sm font-semibold leading-tight">WhatsApp Bot</p>
              <p className="text-xs text-muted-foreground">Terhubung via WhatsApp</p>
            </div>
          </div>
        </div>

        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          <div className="rounded-2xl bg-emerald-50 p-4 text-sm text-emerald-900 border border-emerald-100">
            Mulai chat resmi Infistream melalui WhatsApp. Klik tombol di bawah ini untuk membuka WhatsApp dengan pesan awal otomatis.
          </div>
          <div className="grid gap-3">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-br from-green-500 to-emerald-600 text-white px-4 py-3 font-medium shadow hover:shadow-md active:scale-95 transition"
            >
              Buka WhatsApp
        ...
        <div className="px-4 py-3 border-t border-emerald-200/60 dark:border-white/10 text-xs text-muted-foreground">
          Pastikan Anda sudah masuk WhatsApp di perangkat Anda.
        </div>
      </div>
    </div>
  );
