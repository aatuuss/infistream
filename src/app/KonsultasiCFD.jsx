...
>
  ...
  <div className="grid items-start justify-items-center relative">
    {/* Judul Utama */}
    <h1
      className="col-start-1 row-start-1 z-10 text-center 
                 whitespace-normal sm:whitespace-nowrap
                 text-2xl sm:text-3xl md:text-6xl lg:text-7xl 
                 font-extrabold text-transparent bg-clip-text 
                 bg-[#4facfe] tracking-wide sm:tracking-wider 
                 drop-shadow-[0_0_20px_rgba(97,167,255,0.8)] scroll-animated-h1"
      style={{
    ...
    <img
      ...
      alt="Simulasi CFD"
      className="col-start-1 row-start-1 z-10 w-64 sm:w-80 md:w-96 lg:w-[450px] mx-auto scroll-animated-img"
    />
  </div>

  {/* Teks + Button */}
  <div className="flex flex-col md:flex-row justify-center items-center gap-3 sm:gap-4 relative z-0 scroll-animated-text mt-8 sm:mt-12 md:mt-20 mb-8 sm:mb-12">
    <p className="font-bold text-lg sm:text-xl md:text-3xl text-white drop-shadow-lg text-center md:text-left">
  ...
  >
    ...
    <div className="card-animation-item card-left w-64 sm:w-72 md:w-72 h-36 sm:h-40 md:h-40 drop-shadow-2xl relative">
      <div className="relative z-10 w-full h-full bg-white/50 backdrop-blur-lg rounded-3xl p-3 sm:p-4 flex items-center justify-between">
        <div className="text-white text-lg sm:text-xl md:text-xl font-bold text-center drop-shadow-lg">
          <p>INDUSTRI</p>
          <p>MARITIM</p>
        </div>
