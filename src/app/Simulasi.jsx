...
const Simulasi = () => {
  ...
  useEffect(() => {
    let ctx = gsap.context(() => {
      ...
      // Efek Hover Animasi untuk Card
      const cards = document.querySelectorAll(".card-animation-item");
      cards.forEach((card) => {
  ...
  return (
    <div ref={componentRef} className="relative py-16 overflow-hidden">
      ...
      {/* Cards */}
      <div className="relative z-10 flex gap-4 px-4 overflow-x-auto hide-scrollbar">
        {[
          {
            img: "/img/meeting.png",
