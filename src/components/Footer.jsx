...
const Footer = () => {
  ...
  return (
    <footer className="relative border-t bg-blue-600 text-white"> {/*bg-blue-600*/}
      ...
      <div className="mx-auto max-w-7xl px-5 pb-6 pt-16 lg:px-8 lg:pt-20">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <div className="mt-6 flex items-start gap-3 text-sm text-white">
              <MapPin className="mt-0.5 h-4 w-4 flex-none text-white" />
              <p>
                Jl. Mayang 08, Bunulrejo, Blimbing
                <br />
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm text-white">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:hello@infimech.id" className="hover:text-white">
                  hello@infimech.id
                </a>
              </li>
            </ul>
            ...
            <form onSubmit={handleSubscribe} className="mt-4">
              ...
              <div className="flex rounded-lg ring-1 ring-white/10 focus-within:ring-white/30">
                <input
                  ...
                  className="w-full rounded-l-lg bg-white/5 px-3 py-2 text-sm text-white placeholder:text-white focus:outline-none"
                  required
                />
                <button
                  type="submit"
                  className="rounded-r-lg bg-white px-3 py-2 text-sm font-semibold text-blue-700 transition hover:bg-blue-50"
                >
                  Subscribe
                </button>
              </div>
