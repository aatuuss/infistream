    ...
    <section className="relative isolate bg-[#1E90FF] text-white overflow-hidden">
      ...
      <div className="relative z-10 grid items-center gap-12 py-20 md:py-24 lg:grid-cols-2 container mx-auto px-6 lg:px-12">
        ...
        <div className="space-y-6">
          <h1 className="text-2xl font-extrabold font-sans leading-tight sm:text-5xl tracking-tight">
      ...
      >
        ...
        <div className="relative mx-auto w-full max-w-xl">
         ...
         <div className="pointer-events-none absolute left-[200px] top-60 z-0 h-60 w-[600px] overflow-hidden">
            ...
            {/* Glow */}
            {/* <div className="absolute inset-0 translate-y-8 bg-cyan-400/30 blur-3xl rounded-full animate-pulse" /> */}
...
<div
  ...
  style={{
    ...
    maskImage: "linear-gradient(to top, transparent 0%, white 30%, white 100%)",
    WebkitMaskImage: "linear-gradient(to top, transparent 0%, white 30%, white 100%)",
  }}
/>
  ...
  />
      ...
      {/* Custom keyframes langsung di sini */}
      <style>{`
        @keyframes move {
